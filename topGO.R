...
for (i in 1:length( list_files))
    ...
    {
        geneID2GO <- readMappings(file = "GO.txt",sep="")
        ...
        write.table(x, paste(sep="",strsplit(list_files[[i]], "\\.")[[1]][1],"genes_corresponding_overrepresent_BP_GO.txt"), append=T, row.names=F)
        ...
        write.table(x, paste(sep="",strsplit(list_files[[i]], "\\.")[[1]][1],"genes_corresponding_overrepresent_CC_GO.txt"), append=T, row.names=F)
        ...
        write.table(x, paste(sep="",strsplit(list_files[[i]], "\\.")[[1]][1],"genes_corresponding_overrepresent_MF_GO.txt"), append=T, row.names=F)
