...
v=c(v,rep("Group_4_3_5_samples",5))
#v=c(v,"Eriopersicon")
...
for (i in 1:nrow(CNVs_mean_84_count)) 
    {
        ...
        Group_4_3_5_samples_v=unname(unlist(table_with_CHR_Gene[,c("X53","X52","X55","X47","X48")]))
        Group_4_3_5_samples_v_var=var(as.numeric( Group_4_3_5_samples_v))
        Group_4_3_5_samples_v_mean=mean(as.numeric( Group_4_3_5_samples_v))
        merged_v=as.numeric(c(Lycopersicum_v,Group_4_3_5_samples_v))
        #print(Lycopersicum_v_mean)
        #print(Group_2_9_samples_v_mean)
        #print(merged_v)
        dif_var=abs(Lycopersicum_v_var - Group_4_3_5_samples_v_var)
        dif_mean=(Lycopersicum_v_mean - Group_4_3_5_samples_v_mean)
        #print(dif_mean)
        ...
        results=data.frame(CHR,gene,F.pvalue,t.pval,Lycopersicum_v_var, Group_4_3_5_samples_v_var,dif_var,Lycopersicum_v_mean, Group_4_3_5_samples_v_mean,dif_mean)
        write.table(results,"CNVs_mean_84_count_lm_Lyc_1_VS_Gr_4_3_5-samples.txt",append=T,col.names=T, row.names=T)
         #   }
